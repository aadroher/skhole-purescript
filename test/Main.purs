...
import Test.Spec (it, describe, sequential)
import Test.Spec.Assertions (shouldEqual)
import Test.Spec.Reporter (consoleReporter)
import Test.Spec.Runner.Node (runSpecAndExitProcess)
import Test.TestUtils (timeout)
import Zelkova.Signal ((~>), get, runSignal, filterMap, filter, foldp, (~), (<~), dropRepeats, sampleOn, constant, mergeMany, flatten)
...
main :: Effect Unit
main = runSpecAndExitProcess [consoleReporter] $ sequential do
